...
class SliderComponent extends HTMLElement {
  constructor() {
    ...
    if (this.sliderControlButtons.length) {
      this.sliderControlButtons.forEach((link) => link.addEventListener('click', this.linkToSlide.bind(this)));
    }
  ...
  linkToSlide(event) {
    ...
    const slideScrollPosition =
      ...
      this.sliderItemsToShow[0].clientWidth *
        (Array.from(this.sliderControlButtons).indexOf(event.currentTarget) + 1 - this.currentPage);
    this.slider.scrollTo({
